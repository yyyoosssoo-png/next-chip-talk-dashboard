...
유수연(Suyeon Yoo)/미래반도체
첨부파일
9월 15일 (월) 오후 6:09 (1일 전)
 wns9133@gmail.com, 나에게
...
이번에 코칭 해주시는 주제 관련하여 메일 드립니다.

저희 조에서 했던 “설문 데이터-대쉬보드 웹 페이지 구축” 프로젝트를 개인적으로도 실행해봤는데,

HTML 수정이 어느 순간부터 도돌이표처럼 돌아가는 문제, 실제 웹 페이지로 만드는 과정이 보안상 이슈로 잘 되지 않았습니다. (현재 제일 최신 버전은 ver6 입니다)
...
nct-dashboard_ver6.HTML
nct-dashboard_ver6.HTML 표시 중입니다.
